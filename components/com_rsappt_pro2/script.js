/*
 ****************************************************************
 Copyright (C) 2008-2011 Soft Ventures, Inc. All rights reserved.
 ****************************************************************
 * @package	Appointment Booking Pro - ABPro
 * @copyright	Copyright (C) 2008-2011 Soft Ventures, Inc. All rights reserved.
...
function getSlots(){
	...
	if (xhr) {
		...
		//alert(data);
		xhr.open("GET", presetIndex()+"?option=com_rsappt_pro2&controller=ajax&task=ajax&format=raw&" + data, true);
		xhr.send('');
	}
	else {
...
function doCancel(){
	...
	if (xhr) {
		...
		// synchronous
		xhr.open("GET", presetIndex()+"?option=com_rsappt_pro2&controller=ajax&task=cancel_booking&format=raw&" + data, false);
		xhr.send(null);
...
function doDelete(){
	...
	if (xhr) {
		...
		// synchronous
		xhr.open("GET", presetIndex()+"?option=com_rsappt_pro2&controller=ajax&task=delete_booking&format=raw&" + data, false);
		xhr.send(null);
...
//		}
		...
		// synchronous
		xhr.open("GET", presetIndex()+"?option=com_rsappt_pro2&controller=ajax&task=ajax_validate&format=raw&" + data, false);
		xhr.send(null);
...
function getServices(){
	...
	if (xhr2) {
		...
		xhr2.open("GET", presetIndex()+"?option=com_rsappt_pro2&controller=ajax&task=ajax&format=raw&" + data, true);
		xhr2.send('');
	}
	else {
		alert("Sorry, but I couldn't create an XMLHttpRequest");
...
function buildTable(){
	...
	if (xhr) {
		...
		if(document.getElementById("gad2").value === "Yes"){
			xhr.open("GET", presetIndex()+"?option=com_rsappt_pro2&controller=ajax&task=ajax_gad2&format=raw&" + data, true);
		} else {
			xhr.open("GET", presetIndex()+"?option=com_rsappt_pro2&controller=ajax&task=ajax_gad&format=raw&" + data, true);
		}
		xhr.send('');
	}
	else {
...
function changeUser(){
	...
	if (xhr) {
		...
		// synchronous
		xhr.open("GET", presetIndex()+"?option=com_rsappt_pro2&controller=ajax&task=ajax_fetch&format=raw&" + data, false);
		xhr.send(null);
...
function buildFrontDeskView(day, month, year, week_offset){
	...
	if (xhr) {
		...
		data = data + "&browser=" + BrowserDetect.browser;
		//alert(data);
		xhr.open("GET", presetIndex()+"?option=com_rsappt_pro2&controller=ajax&task=ajax_calview&format=raw&" + data, true);
		xhr.send(null);
	}
	else {
		alert("Sorry, but I couldn't create an XMLHttpRequest");
...
function checkForBookingOverlap(startdate, starttime, enddate, endtime, resource){
	...
	if (xhr) {
		...
		// asynchronous
		xhr.open("GET", presetIndex()+"?option=com_rsappt_pro2&controller=ajax&task=ajax_check_overlap&format=raw&" + data, true);
		xhr.send('');
...
function getResourceUFDs(){
	...
	if (xhr3) {
		...
		//alert(data);
		xhr3.open("GET", presetIndex()+"?option=com_rsappt_pro2&controller=ajax&task=ajax&format=raw&" + data, true);
		xhr3.send('');
	}
	else {
		alert("Sorry, but I couldn't create an XMLHttpRequest");
...
function getResourceSeatTypes(){
	...
	if (xhr4) {
		...
		//alert(data);
		xhr4.open("GET", presetIndex()+"?option=com_rsappt_pro2&controller=ajax&task=ajax&format=raw&" + data, true);
		xhr4.send('');
	}
	else {
		alert("Sorry, but I couldn't create an XMLHttpRequest");
...
function getExtras(){
	...
	if (xhr5) {
		...
		//alert(data);
		xhr5.open("GET", presetIndex()+"?option=com_rsappt_pro2&controller=ajax&task=ajax&format=raw&" + data, true);
		xhr5.send('');
	}
	else {
		alert("Sorry, but I couldn't create an XMLHttpRequest");
...
function checkWhoBooked(which){
	...
	if (xhr27) {
		...
		// asynchronous
		xhr27.open("GET", "./index.php?option=com_rsappt_pro2&controller=ajax&task=ajax_who_booked&format=raw&" + data, true);
